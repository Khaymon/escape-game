...
## Нынешний геймплей
На нынешнем этапе разработки игрок может перемещаться по карте с помощью кнопок A, D, W, S. Символ "^" на карте обозначает сундук, "]" - дверь, "0" - портал, "#" - стена, "@" - игрок. Выйти из игры можно с помощью кнопки Q. 
